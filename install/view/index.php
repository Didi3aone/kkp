...
<html lang="en">
    <head>
        ...
        <script type='text/javascript'  src='../install/assets/js/jquery-3.2.0.min.js'></script>
                        ...
                        <div role="tabpanel" class="tab-pane" id="configuration-tab">
                            <form name="config-form" id="config-form" action="do_install.php" method="post">
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        <div class="form-group clearfix">
                                            <label for="first_name" class=" col-md-3">Username</label>
                                            <div class="col-md-9">
                                                <input type="text" value=""  id="first_name"  name="username" class="form-control"  placeholder="Your first name" />
                                            </div>
                                        </div>
                                        <!-- <div class="form-group clearfix">
